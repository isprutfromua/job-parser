...
def build_sources() -> list[SourceDefinition]:
    return [
        ...
        SourceDefinition(
            ...
            card_selector="#pjax-jobs-list > div, #pjax-job-list > div, #jobs-list > div, .job-link",
            title_selector="h2 > a, h2 a",
            link_selector="h2 > a, h2 a",
            company_selector="img",
            date_selector="h2 > a, h2 a",
            next_selector=".pagination > li:last-child > a, ul.pagination li:last-child > a",
